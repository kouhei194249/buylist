...
class ThingController extends Controller
{
    ...
    {
        return view('things/list')->with(['things' => $thing->getPaginateByLimit(),'category_title' => $category->category, 'possession' => $saving->where('user_id',1)->first()->possession]) ; 
    }
    ...
    {
        return view('things/edit')->with(['thing' => $thing,'categories'=>$category->get()]);
    }
